...
def _build_greeting_response(user_id: int, orch: TelegramOrchestrator) -> str:
    ...
    return (
        ...
        "<b>💪 Health</b>\n"
        "• /health_import — Send a CSV with caption, or /health_import_quick &lt;text&gt; to paste\n"
...
def _helpme(orch: TelegramOrchestrator):
    async def handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        help_message = (
            ...
            "🔹 /health_import — Send a CSV with caption /health_import (optional: garmin|fatsecret|arboleaf)\n"
